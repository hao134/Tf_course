...
#
#
# print(tf.keras.metrics.mean_absolute_error(x_valid, results).numpy()) -> 3.02
...
model.compile(loss= "mse", optimizer = tf.keras.optimizers.SGD(lr=1e-5, momentum = 0.9))# YOUR CODE HERE #, optimizer=# YOUR CODE HERE#))
...
print("After adjust, the mae, need less than 3.0:",tf.keras.metrics.mean_absolute_error(x_valid, results).numpy())